...
[Functions]
  active = 'outer_pressure_fct2 timestep_function inner_pressure_fct outer_pressure_fct1'
  [./temp_ic]
    type = ParsedFunction
...
[Kernels]
  active = 'mech_dissip damage_dt diff_temp dt_temp dp_dt'
  [./dp_dt]
    type = TimeDerivative
...
[BCs]
  [./Pressure]
    ...
    [./press_outer_horizontal]
      function = outer_pressure_fct1
      boundary = 1
      disp_y = disp_y
      disp_x = disp_x
    [../]
    [./press_outer_vertical]
      function = outer_pressure_fct2
      boundary = 2
      disp_y = disp_y
      disp_x = disp_x
    [../]
...
[Outputs]
  ...
  file_base = Anisotr_thermo_test1
[]
